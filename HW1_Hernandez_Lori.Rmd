...
names(fifty_Hertz)[names(fifty_Hertz) == "ï..Date"] <- "Date"
names(Amprion)[names(Amprion) == "ï..Date"] <- "Date"
names(TenneTTSO)[names(TenneTTSO) == "ï..Date"] <- "Date"
names(TransnetBW)[names(TransnetBW) == "ï..Date"] <- "Date"
